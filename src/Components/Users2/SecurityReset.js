      ...
      <Box sx={{ display: lg ? "flex" : "block" }}>
        ...
        >
          <Grid2 container spacing={2}>
            <Grid2 item size={{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12 }}>
              <div className='display-2 mb-10'>
                <h2 style={{ margin: 0 }}>Security Reset Request Management</h2>
              </div>
          ...
          >
            <Box sx={style}>
              <div className='display-2 mb-10'>
                <h3>User Security Reset Request Details</h3>
              ...
              <Grid2 container spacing={2}>
                  ...
                  <Box>
                    <div className='mt-10 p2p-user'>
                      ...
                      <div>
                        ...
                        inq_VmM2cNKPVQ4g2fNvGaJKERHdcrLd
                      </div>
                      <div>
                        <strong>Request Methods: </strong>email
                      </div>
                ...
                <Grid2 item size={{ xs: 12, sm: 12, md: 6, lg: 6 }}>
                  <Box>
                    <div className='mt-10 p2p-user'>
                      ...
                      <div>
                        <strong>User Code : </strong> u-1710737180616
                      </div>
                      <div>
                        <strong>Current Email : </strong>{" "}
                        tradiumpro10@mailto.plus
                      </div>
                      <div>
                        <strong>Current Phone : </strong>N/A
                      </div>
                      <div>
                        <strong>Answer Tried: </strong>0
                      </div>{" "}
                      <div>
                        <strong>Reset value Tried : </strong>1
                      </div>
                    </div>
                  </Box>
                </Grid2>{" "}
                <Grid2 item size={{ xs: 12 }}>
                  <div>
                    Note: No security verification done by otp code. And, user
                    has no questions in settings
                  </div>
                </Grid2>
                <Grid2 item size={{ xs: 12 }}>
                  <ReusableTable
