  ...
  useEffect(() => {
    setCollections({
      columns: [
        ...
        { Header: "Order Amount", accessor: "order_amount", align: "left" },
        { Header: "Payment Amount", accessor: "payment_amount", align: "left" },
          ...
          <Grid2 container spacing={2}>
            <Grid2 item size={{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12 }}>
              <div className='display-2 mb-10'>
                <h2 style={{ margin: 0 }}>My Assigned Order List</h2>
              </div>
